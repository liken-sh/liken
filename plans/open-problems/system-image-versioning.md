...
2026-08-26, after a review found three ways it could block a rollout.
The constraints below record that review. They do not select a
replacement.
...
This is one candidate, and other designs remain open.
...
The fix is a broader design for deployment, scheduling, and credentials.
A node-critical operator must still start from its own OS during upgrade
